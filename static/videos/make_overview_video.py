...
TIMELINE: list[ClipSpec | GridSpec] = [
    ...
    GridSpec(
        clips=(
            ClipSpec("real/axis/small_tennis_axis.mp4", "small tennis", 14.0, speed=2.0, start_frac=0.08, x_focus=0.15),
            ClipSpec("real/axis/middle_tennis_axis.mp4", "middle tennis", 14.0, speed=2.0, start_frac=0.08, x_focus=0.15),
            ClipSpec("real/axis/tennis_axis.mp4", "standard tennis", 14.0, speed=2.0, start_frac=0.08, x_focus=0.15),
            ClipSpec("real/axis/corner_block_axis.mp4", "corner block", 14.0, speed=2.0, start_frac=0.05, x_focus=0.15),
    ...
    GridSpec(
        clips=(
            ClipSpec("arm/sim/small_hammer.mp4", "small hammer", 5.0, speed=2.0306, start_frac=0.0, x_focus=0.50),
            ClipSpec("arm/sim/blue_brush.mp4", "blue brush", 5.0, speed=0.7256, start_frac=0.0, x_focus=0.50),
            ClipSpec("arm/sim/staples_marker.mp4", "staples marker", 5.0, speed=0.8544, start_frac=0.0, x_focus=0.50),
            ClipSpec("arm/sim/mallet_hammer.mp4", "mallet hammer", 5.0, speed=1.7052, start_frac=0.0, x_focus=0.50),
        ),
